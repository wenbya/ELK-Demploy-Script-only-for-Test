...
sudo echo "server.host: '$VMNAME'" >> /etc/kibana/kibana.yml
sudo echo "elasticsearch.url: 'http://$VMNAME:9200'" >> /etc/kibana/kibana.yml
...
##
## you can also do the download .tar.gz
...
sudo mv /usr/share/logstash/bin/logstash /etc/init.d/logstash
